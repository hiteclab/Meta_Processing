// META_PROCESSING Version Alpha 1.2b
...
// Se arregla error con instrucciones arduino
// se corrige error Ejecutar y Exportar cuando la ruta tiene carpetas que usan en sus nombres el caracter espacio en Windows, Linux y Mac
// se corrrige error seleccionar boton del raton en ventana para agregar condición
// se corrige error abrir carpeta data en linux cuado la ruta tiene carpetas que usan en sus nombres el caracter espacio
// Se agrega mostrar el nombre del boton en la misma linea de código cuando se agrega una condicion de click con el ratón
// Se corrige error al agregar lineas en pestaña de configuración
// Se incluye un nuevo boton para agregar línea antes de línea 1 en cualquier pestaña (Principal, Ratón, Teclado, Configuración)
...
// corregir editor texto para mover cursor dentro de la cadena
// corregir slider escala de grises en ventana de selección de color
// Permitir al usuario personalizar colores interfaz
// encapsular de código
// seleccionar tipo de variable
// permitr renombrar variables
// boton verde agregar línea para la primera linea de la ventana
...
Grayscale  =   RGB
  ...
  void draw() {
    ...
    */
    ...
    fill(fondotabs); // 0
    stroke(128);
    rect(0, height-71, 560, height ); // Pestaña configuración
    rect(0, height-71, 420, height ); // Pestaña Teclado
    rect(0, height-71, 280, height ); // Pestaña Ratón
    rect(0, height-71, 140, height ); // Pestaña codigo Principal
    fill(fondotabsresalta); // 50
    if (codetab==0 || mouseX<140 && mouseY > height-71 && mouseY < height)rect(0, height-71, 140, height ); // Resalta pestaña Código Principal
    if (codetab==1 || mouseX > 140 && mouseX < 280 && mouseY > height-71 && mouseY < height)rect(140, height-71, 140, height ); // Resalta pestaña Raton
    if (codetab==2 || mouseX > 280 && mouseX < 420 && mouseY > height-71 && mouseY < height)rect(280, height-71, 140, height ); // Resalta pestaña Teclado
    if (codetab==3 || mouseX > 420 && mouseX < 560 && mouseY > height-71 && mouseY < height)rect(420, height-71, 140, height ); // Resalta pestaña configuación
    fill(128);
    text(idiomagui.getString("Principal"), 10, height-51);
    text(idiomagui.getString("Ratón"), 150, height-51);
    text(idiomagui.getString("Teclado"), 290, height-51);
    text(idiomagui.getString("Configuración"), 430, height-51);
    fill(fondobarrainf); //80
...
/////////////////////
      ...
      // Muestra boton agregar línea antes de línea 1 pestaña Principal
      if (codetab==0 && mouseX<30 && mouseY< 60 && mouseY >40 && icodigo+lineaactual == 0 ) {
          fill(#1BF50C);
          noStroke();
          ellipse(15, 33+20*y, 20, 20);
          fill(0);
          text("+", 10, 38+20*y);       
      }

      // Muestra boton agregar línea antes de línea 1 pestaña Ratón
      if (codetab==1 && mouseX<30 && mouseY< 60 && mouseY >40 && imouse+lineaactual == 0 ) {
          fill(#1BF50C);
          noStroke();
          ellipse(15, 33+20*y, 20, 20);
          fill(0);
      ...
      // Muestra boton agregar línea antes de línea 1 pestaña Teclado
      if (codetab==2 && mouseX<30 && mouseY< 60 && mouseY >40 && iteclado+lineaactual == 0 ) {
          fill(#1BF50C);
          noStroke();
          ellipse(15, 33+20*y, 20, 20);
          fill(0);
      ...
      // Muestra boton agregar línea antes de línea 1 pestaña Configuración
      if (codetab==3 && mouseX<30 && mouseY< 60 && mouseY >40 && iconfig+lineaactual == 0 ) {
          fill(#1BF50C);
          noStroke();
          ellipse(15, 33+20*y, 20, 20);
          fill(0);
    ...
    if (y>0 && y <=tlineas && mouseY<height-71 && tlineas >= icodigo+y ) {
      ...
      if (codetab==3) if(iconfig+(lineaactual)<= maximolineas) linearaton=y; 
...
//Ftext(icodigo+"  "+(linearaton-1)+"   "+lineaactual,mouseX, mouseY);
  ...
  void keyPressed() {
    ...
    if (ctrlPressed && keyCode == int('X') ) {
      ...
      if (codetab==3) ctrlcline = cargaconfiguracion.getJSONObject(lineaactual); 
         ...
         // pestaña principal
        if (codetab==0) { 
          if(cargacodigo.size()>1){cargacodigo.remove(lineaactual); 
          tlineas--;
          lineaactual--;
          } else { JSONObject renuevaobjeto = new JSONObject(); renuevaobjeto.setInt("id", -1); cargacodigo.setJSONObject(0, renuevaobjeto);}
        }
        // pestaña raton
        if (codetab==1) { 
          if(cargamouse.size()>1){cargamouse.remove(lineaactual);
          tlineasmouse--;
          lineaactual--;
          } else { JSONObject renuevaobjeto = new JSONObject(); renuevaobjeto.setInt("id", -1); cargamouse.setJSONObject(0, renuevaobjeto);}
        }
        // pestaña teclado
        if (codetab==2) { 
          if(cargateclado.size()>1){cargateclado.remove(lineaactual); 
          tlineasteclado--;
          lineaactual--;
          } else { JSONObject renuevaobjeto = new JSONObject(); renuevaobjeto.setInt("id", -1); cargateclado.setJSONObject(0, renuevaobjeto);}
        }
        // pestaña configuracion
        if (codetab==3) { 
          if(cargaconfiguracion.size()>1){cargaconfiguracion.remove(lineaactual); 
          tlineasconfig--;
          lineaactual--;
          } else { JSONObject renuevaobjeto = new JSONObject(); renuevaobjeto.setInt("id", -1); cargaconfiguracion.setJSONObject(0, renuevaobjeto);}
        }
  ...
  void mousePressed() {
    ...
    if (mouseX<140 && mouseY > height-71 && mouseY < height) {
    ...
    // Boton pestaña: Raton
    if (mouseX > 140 && mouseX < 280 && mouseY > height-71 && mouseY < height) {
    ...
    if (mouseX > 280 && mouseX < 420 && mouseY > height-71 && mouseY < height) {
    ...
    if (mouseX > 420 && mouseX < 560 && mouseY > height-71 && mouseY < height){
    ...
    if (mouseX>20 && mouseX<40 && mouseY>10 && mouseY<30) {
      ...
      String[] command = {"/bin/bash", "-c", "cd \""+metafolder+"processing\"; sh processing-java --sketch=\""+sketchfolder+proyectonombre+"\" --force --run"};
      ...
      if( OS.contains("mac") == true) {
        ...
        String[] commandToRun = {"/bin/bash", "-c", "cd \""+metafolder+"\"; sh processing-java --sketch=\""+sketchfolder+proyectonombre+"\" --force --run"};
        try {Process p = exec(commandToRun);} catch (Exception e) {println(e);}
      }
    ...
    if (mouseX>500 && mouseX<525 && mouseY>10 && mouseY<30) {
      ...
      if( OS.contains("linux") == true) {
        ...
        String[] command = {"/bin/bash", "-c", "cd \""+metafolder+"/processing\"; sh processing-java --sketch=\""+sketchfolder+proyectonombre+"\" --output=\""+sketchfolder+proyectonombre+"/app"+"\" --force --export"};
        Process p= exec(command); 
      } 
      ...
      if( OS.contains("mac") == true) {
        ...
        */
        ...
        String[] commandToRun = {"/bin/bash", "-c", "cd \""+metafolder+"\"; sh processing-java --sketch=\""+sketchfolder+proyectonombre+"\" --output=\""+sketchfolder+proyectonombre+"/app"+"\" --force --export"};
        try {Process p = exec(commandToRun);} catch (Exception e) {println(e);}
      }
    ...
    ///////////////////////
      ...
      // boton agregar línea antes de línea 1 pestaña Principal
      if (codetab==0 && mouseX<30 && mouseY< 60 && mouseY >40 && icodigo+lineaactual == 0 ) {
          JSONArray temp = new JSONArray();
      ...
      // boton agregar línea antes de línea 1 pestaña Ratón
      if (codetab==1 && mouseX<30 && mouseY< 60 && mouseY >40 && imouse+lineaactual == 0 ) {
          JSONArray temp = new JSONArray();
          JSONObject obj = new JSONObject();
          obj.setInt("id", -1);
      ...
      // boton agregar línea antes de línea 1 pestaña Teclado
      if (codetab==2 && mouseX<30 && mouseY< 60 && mouseY >40 && iteclado+lineaactual == 0 ) {
          JSONArray temp = new JSONArray();
          JSONObject obj = new JSONObject();
          obj.setInt("id", -1);
      ...
      // boton agregar línea antes de línea 1 pestaña Configuración
      if (codetab==3 && mouseX<30 && mouseY< 60 && mouseY >40 && iconfig+lineaactual == 0 ) {
    ...
    if (y < tlineas+1 && ventana==false && mouseButton==LEFT && mouseX < widthline+40 && mouseX > 30 && mouseY>40 && mouseY< height-70 ) {
      ventana=true;
...
//////////////////////////////////
  ...
  void muestralinea(int i) {
    ...
    // muestra el nombre del boton cuando se agrega una condicion de click con el ratón
    if(codetab==0){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Derecho"), widthlinenow+107, 60+((20*i)-(20*icodigo)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+107, 60+((20*i)-(20*icodigo)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Izquierdo"), widthlinenow+107, 60+((20*i)-(20*icodigo)) ); //boton izquierdo
    }
    if(codetab==1){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Derecho"), widthlinenow+107, 60+((20*i)-(20*imouse)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+107, 60+((20*i)-(20*imouse)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Izquierdo"), widthlinenow+107, 60+((20*i)-(20*imouse)) ); //boton izquierdo
    }
    if(codetab==2){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Derecho"), widthlinenow+107, 60+((20*i)-(20*iteclado)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+107, 60+((20*i)-(20*iteclado)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Izquierdo"), widthlinenow+107, 60+((20*i)-(20*iteclado)) ); //boton izquierdo
    }
    if(codetab==3){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Derecho"), widthlinenow+107, 60+((20*i)-(20*iconfig)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+107, 60+((20*i)-(20*iconfig)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Izquierdo"), widthlinenow+107, 60+((20*i)-(20*iconfig)) ); //boton izquierdo
    }
  ...
  void guardapde(int modo){
      ...
      for (int i=1; i-1<tlineasteclado; i++) {
        if (cargateclado.getJSONObject(i-1).isNull("pde") == false) {
          ...
          if (cargateclado.getJSONObject(i-1).getInt("id") == 11) { // entradadigital
            libarduino=true;
          }
          if (cargateclado.getJSONObject(i-1).getInt("id") == 12) { // entradaanalogica
            libarduino=true;
          }
          if (cargateclado.getJSONObject(i-1).getInt("id") == 13) { // servo
            libarduino=true;
          } 
          
          // abre { para el la estructura condicional
          if (cargateclado.getJSONObject(i-1).getInt("id") == 105 && cargateclado.getJSONObject(i).getInt("id") != 105)texto [i-1] = texto [i-1]+"\n{";
      ...
      for (int i=1; i-1<tlineasmouse; i++) {
        if (cargamouse.getJSONObject(i-1).isNull("pde") == false) {
          ...
          if (cargamouse.getJSONObject(i-1).getInt("id") == 11) { // entradadigital
            libarduino=true;
          }
          if (cargamouse.getJSONObject(i-1).getInt("id") == 12) { // entradaanalogica
            libarduino=true;
          }
          if (cargamouse.getJSONObject(i-1).getInt("id") == 13) { // servo
            libarduino=true;
          }
          
          // abre { para el la estructura condicional
          if (cargamouse.getJSONObject(i-1).getInt("id") == 105 && cargamouse.getJSONObject(i).getInt("id") != 105)texto [i-1] = texto [i-1]+"\n{";
      ...
      for (int i=1; i-1<tlineasconfig; i++) {
        if (cargaconfiguracion.getJSONObject(i-1).isNull("pde") == false) {
          ...
          if (cargaconfiguracion.getJSONObject(i-1).getInt("id") == 11) { // entradadigital
            libarduino=true;
          }
          if (cargaconfiguracion.getJSONObject(i-1).getInt("id") == 12) { // entradaanalogica
            libarduino=true;
          }
          if (cargaconfiguracion.getJSONObject(i-1).getInt("id") == 13) { // servo
            libarduino=true;
          }
          
          // abre { para el la estructura condicional
          if (cargaconfiguracion.getJSONObject(i-1).getInt("id") == 105 && cargaconfiguracion.getJSONObject(i).getInt("id") != 105)texto [i-1] = texto [i-1]+"\n{";
      ...
      for (int i=1; i-1<tlineas; i++) {
        if (cargacodigo.getJSONObject(i-1).isNull("pde") == false) {
          ...
          if (cargacodigo.getJSONObject(i-1).getInt("id") == 11) { // entradadigital
            libarduino=true;
          }
          if (cargacodigo.getJSONObject(i-1).getInt("id") == 12) { // entradaanalogica
            libarduino=true;
          }
          if (cargacodigo.getJSONObject(i-1).getInt("id") == 13) { // servo
            libarduino=true;
          }
          
          // abre { para el la estructura condicional
          if (cargacodigo.getJSONObject(i-1).getInt("id") == 105 && cargacodigo.getJSONObject(i).getInt("id") != 105)texto [i-1] = texto [i-1]+"\n{";
