...
// se corrige error de ruta tiene carpetas usando en sus nombres el caracter espacio en Windows, Linux y Mac
// se corrrige error seleccionar boton del raton en ventana para agregar condición
// se corrige error abrir carpeta data en linux cuado la ruta tiene carpetas usando en sus nombres el caracter espacio
// Se agrega mostrar en la misma linea de código el nombre del boton cuando se agrega una condicion de click con el ratón
...
//////////////////////////////////
  ...
  void muestralinea(int i) {
    ...
    if(codetab==0){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Derecho"), widthlinenow+47, 60+((20*i)-(20*icodigo)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+47, 60+((20*i)-(20*icodigo)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Izquierdo"), widthlinenow+47, 60+((20*i)-(20*icodigo)) ); //boton izquierdo
    }
    if(codetab==1){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Derecho"), widthlinenow+47, 60+((20*i)-(20*imouse)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+47, 60+((20*i)-(20*imouse)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Izquierdo"), widthlinenow+47, 60+((20*i)-(20*imouse)) ); //boton izquierdo
    }
    if(codetab==2){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Derecho"), widthlinenow+47, 60+((20*i)-(20*iteclado)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+47, 60+((20*i)-(20*iteclado)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Izquierdo"), widthlinenow+47, 60+((20*i)-(20*iteclado)) ); //boton izquierdo
    }
    if(codetab==3){
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("37")) text(""+idiomagui.get("Derecho"), widthlinenow+47, 60+((20*i)-(20*iconfig)) ); //boton derecho
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("3")) text(""+idiomagui.get("Central"), widthlinenow+47, 60+((20*i)-(20*iconfig)) ); //boton central
      if (id == 105 && objetoml.getString("valor1v").equals("click") && objetoml.getString("valor2").equals("39")) text(""+idiomagui.get("Izquierdo"), widthlinenow+47, 60+((20*i)-(20*iconfig)) ); //boton izquierdo
    }
